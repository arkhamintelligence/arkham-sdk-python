...
class Arkham:
    ...
    def get_account_airdrops(self, subaccount_id: Optional[int] = None, before: Optional[int] = None, limit: Optional[int] = None) -> List["Airdrop"]:
        ...
        return self._make_request("GET", f"/account/airdrops", params={"subaccountId": subaccount_id, "before": before, "limit": limit})  # type: ignore
    ...
    def get_account_balance_updates(self, subaccount_id: Optional[int] = None, before: Optional[int] = None, reason: Optional["PositionUpdateReason"] = None, limit: Optional[int] = None) -> List["BalanceUpdate"]:
        ...
        return self._make_request("GET", f"/account/balance-updates", params={"subaccountId": subaccount_id, "before": before, "reason": reason, "limit": limit})  # type: ignore
    ...
    def get_portfolio_balance_history(self, subaccount_id: Optional[int] = None, start: Optional[int] = None, end: Optional[int] = None) -> List["HistoricBalance"]:
        ...
        return self._make_request("GET", f"/account/balances/history", params={"subaccountId": subaccount_id, "start": start, "end": end})  # type: ignore
    ...
    def get_account_commissions(self, subaccount_id: Optional[int] = None, before: Optional[int] = None, limit: Optional[int] = None) -> List["Commission"]:
        ...
        return self._make_request("GET", f"/account/commissions", params={"subaccountId": subaccount_id, "before": before, "limit": limit})  # type: ignore
    ...
    def get_deposit_addresses(self, subaccount_id: Optional[int] = None, chain: str = None) -> "DepositAddressesResponse":
        ...
        return self._make_request("GET", f"/account/deposit/addresses", params={"subaccountId": subaccount_id, "chain": chain})  # type: ignore
    ...
    def get_account_deposits(self, subaccount_id: Optional[int] = None, before: Optional[int] = None, limit: Optional[int] = None) -> List["Deposit"]:
        ...
        return self._make_request("GET", f"/account/deposits", params={"subaccountId": subaccount_id, "before": before, "limit": limit})  # type: ignore
    ...
    def get_funding_rate_payments(self, subaccount_id: Optional[int] = None, before: Optional[int] = None, limit: Optional[int] = None) -> List["FundingRatePayment"]:
        ...
        return self._make_request("GET", f"/account/funding-rate-payments", params={"subaccountId": subaccount_id, "before": before, "limit": limit})  # type: ignore
    ...
    def get_account_lsp_assignments(self, subaccount_id: Optional[int] = None, before: Optional[int] = None, limit: Optional[int] = None) -> List["LspAssignment"]:
        ...
        return self._make_request("GET", f"/account/lsp-assignments", params={"subaccountId": subaccount_id, "before": before, "limit": limit})  # type: ignore
    ...
    def get_account_position_updates(self, subaccount_id: Optional[int] = None, before: Optional[int] = None, reason: Optional["PositionUpdateReason"] = None, limit: Optional[int] = None) -> List["PositionUpdate"]:
        ...
        return self._make_request("GET", f"/account/position-updates", params={"subaccountId": subaccount_id, "before": before, "reason": reason, "limit": limit})  # type: ignore
    ...
    def get_account_realized_pnl(self, subaccount_id: Optional[int] = None, before: Optional[int] = None, limit: Optional[int] = None) -> List["RealizedPnl"]:
        ...
        return self._make_request("GET", f"/account/realized-pnl", params={"subaccountId": subaccount_id, "before": before, "limit": limit})  # type: ignore
    ...
    def get_account_rebates(self, subaccount_id: Optional[int] = None, before: Optional[int] = None, limit: Optional[int] = None) -> List["Rebate"]:
        ...
        return self._make_request("GET", f"/account/rebates", params={"subaccountId": subaccount_id, "before": before, "limit": limit})  # type: ignore
    ...
    def set_price_alert(self, data: "SetPriceAlertRequest", subaccount_id: Optional[int] = None, symbol: Optional[str] = None) -> None:
        ...
        return self._make_request("PUT", f"/account/settings/price-alert", params={"subaccountId": subaccount_id, "symbol": symbol}, json_data=data)  # type: ignore
    ...
    def get_account_transfers(self, subaccount_id: Optional[int] = None, before: Optional[int] = None, limit: Optional[int] = None) -> List["Transfer"]:
        ...
        return self._make_request("GET", f"/account/transfers", params={"subaccountId": subaccount_id, "before": before, "limit": limit})  # type: ignore
    ...
    def get_account_withdrawals(self, subaccount_id: Optional[int] = None, before: Optional[int] = None, limit: Optional[int] = None) -> List["Withdrawal"]:
        ...
        return self._make_request("GET", f"/account/withdrawals", params={"subaccountId": subaccount_id, "before": before, "limit": limit})  # type: ignore
    ...
    def dex_price(self, chain_id: Optional[int] = None, sell_token: Optional[str] = None, buy_token: Optional[str] = None, sell_amount: Optional[str] = None, taker: Optional[str] = None, slippage_bps: Optional[int] = None) -> "AllowanceHolderBaseResponse":
        ...
        return self._make_request("GET", f"/dex/price", params={"chainId": chain_id, "sellToken": sell_token, "buyToken": buy_token, "sellAmount": sell_amount, "taker": taker, "slippageBps": slippage_bps})  # type: ignore
    ...
    def dex_quote(self, chain_id: Optional[int] = None, sell_token: Optional[str] = None, buy_token: Optional[str] = None, sell_amount: Optional[str] = None, taker: Optional[str] = None, slippage_bps: Optional[int] = None) -> "AllowanceHolderBaseResponse":
        ...
        return self._make_request("GET", f"/dex/quote", params={"chainId": chain_id, "sellToken": sell_token, "buyToken": buy_token, "sellAmount": sell_amount, "taker": taker, "slippageBps": slippage_bps})  # type: ignore
    ...
    def dex_trade_history(self, address: Optional[str] = None, chain_id: Optional[int] = None, limit: Optional[int] = None) -> List["DexTradeHistoryItem"]:
        ...
        return self._make_request("GET", f"/dex/trades", params={"address": address, "chainId": chain_id, "limit": limit})  # type: ignore
    ...
    def get_open_order_by_client_order_id(self, subaccount_id: Optional[int] = None, client_order_id: Optional[str] = None) -> "Order":
        ...
        return self._make_request("GET", f"/orders/by-client-order-id", params={"subaccountId": subaccount_id, "clientOrderId": client_order_id})  # type: ignore
    ...
    def get_order_history(self, symbol: Optional[str] = None, subaccount_id: Optional[int] = None, limit: Optional[int] = None, offset: Optional[int] = None) -> List["Order"]:
        ...
        return self._make_request("GET", f"/orders/history", params={"symbol": symbol, "subaccountId": subaccount_id, "limit": limit, "offset": offset})  # type: ignore
    ...
    def get_all_orders_by_client_order_id(self, subaccount_id: Optional[int] = None, client_order_id: Optional[str] = None) -> List["Order"]:
        ...
        return self._make_request("GET", f"/orders/history/by-client-order-id", params={"subaccountId": subaccount_id, "clientOrderId": client_order_id})  # type: ignore
    ...
    def get_order_history_with_total(self, symbol: Optional[str] = None, subaccount_id: Optional[int] = None, limit: Optional[int] = None, offset: Optional[int] = None) -> "OrderHistoryWithTotalResponse":
        ...
        return self._make_request("GET", f"/orders/history_offset", params={"symbol": symbol, "subaccountId": subaccount_id, "limit": limit, "offset": offset})  # type: ignore
    ...
    def get_candles(self, symbol: str = None, duration: "CandleDurationName" = None, start: int = None, end: int = None) -> List["Candle"]:
        """Get Candles

        Args:
                symbol (str)
                duration (CandleDurationName)
                start (int): Time in microseconds since unix epoch
                end (int): Time in microseconds since unix epoch
        Raises:
                ArkhamError - on API error
    ...
    def get_user_trades(self, symbol: Optional[str] = None, subaccount_id: Optional[int] = None, before: Optional[int] = None, limit: Optional[int] = None) -> List["UserTrade"]:
        ...
        return self._make_request("GET", f"/trades", params={"symbol": symbol, "subaccountId": subaccount_id, "before": before, "limit": limit})  # type: ignore
    ...
    def get_user_trades_with_totals(self, symbol: Optional[str] = None, subaccount_id: Optional[int] = None, limit: Optional[int] = None, offset: Optional[int] = None) -> "UserTradesWithTotalsResponse":
        ...
        return self._make_request("GET", f"/trades/history", params={"symbol": symbol, "subaccountId": subaccount_id, "limit": limit, "offset": offset})  # type: ignore

    def get_user_trades_by_time(self, subaccount_id: Optional[int] = None, from_: Optional[int] = None, to: Optional[int] = None, limit: Optional[int] = None) -> List["UserTrade"]:
        ...
        return self._make_request("GET", f"/trades/time", params={"subaccountId": subaccount_id, "from": from_, "to": to, "limit": limit})  # type: ignore
